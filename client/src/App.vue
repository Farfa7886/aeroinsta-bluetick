...
function copyServerUrl() {
  navigator.clipboard.writeText("ewbfiweifwefbiowe")
  ...
  <div style="display: flex; align-items: center; justify-content: center; height: 100vh; width: 100%;">
    <div style="margin: 30px;">
      ...
      <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-2">
        <input type="text" placeholder="Instagram username" class="input input-bordered input-primary w-full" />
      ...
      <div style="text-align: center; margin-top: 30px;">
        ...
        <div style="display: flex; justify-content: center; align-items: center;">
          <kbd class="kbd kbd-lg" style="margin-top: 30px;">wefbwiqefgipuwqefgpiqwfiq</kbd>
